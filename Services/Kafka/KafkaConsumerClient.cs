...
namespace Cjora.MQ.Services
{
    /// <summary>
    /// Kafka 消息队列实现消费功能
    /// 使用内存 Channel 作为缓冲区，实现异步消费。
    /// </summary>
    public sealed class KafkaConsumerClient : IMqConsumer
    {
        /// <summary>
        /// 实例名称
        /// </summary>
        ...
        public KafkaConsumerClient(string name, MqProfileOptions profile, ILogger<KafkaConsumerClient> logger)
        {
            Name = name;
            _profile = profile;
            _logger = logger;
